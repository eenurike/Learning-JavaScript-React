...
console.log(a); // => 5
/*
Тут видим что значение в переменной "a" осталось изначальное
*/
...
Мы будем нормально работать только с поверхностными свойствами
...
log(100,"yo",true);
Не передаем таким образом log([...num]), ведь в 
num итак лежит массив!
*/
