...
Например incr у нас 10, потом ++, но число уже не может увеличится, так как 10 уже вывелось.
...
/*
Козалось бы мы получим результаты 10 и 10, но сперва сделали операцию,
а потом вывели его
*/
...
И поэтому результат поменялся, потомучто одно из значений правдиво 
*/
...
console.log(2+2+2 != 8);    // => true. ДА, 6 не равно 8
