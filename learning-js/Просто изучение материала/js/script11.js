...
с разделителем ; и пробелом. Если записать просто join()
...
let array = ["б", "в", "а", "г"];
array.sort();
console.log(array);     // И получаем буквы в алфавитном порядке, с цифрами так же НО

let num = [1, 3, 2, 20];
num.sort();
console.log(num);       // => 1,2,20,3 не то что мы ожидали
/*
Потому что сорт принемает в виде строки, и видит первый символ у 20
