...
// 2) Более современный метод, и они бклее функциональны 
...
и один самый большой сплюс этого метода в том, что у первого способа
не никаких методов, а querySelectorAll это исключение, у него
есть метод forEach()
*/
console.log(hearts);
/*
