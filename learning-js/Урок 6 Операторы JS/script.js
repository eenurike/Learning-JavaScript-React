...
// Оператор инкаримента и декримента
...
decr--; // Оператор декримента, уменьщение на один  (префиксная форма)
