...
// Например у нас будет большой проект и кода тоже будет много, и когда мы захотим получит какой нибудь результат из этих переменных, мы не поймем за что эти переменные отвечают
