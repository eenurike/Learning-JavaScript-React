...
function test() {
  ...
  console.log('done');
  // Для теста специально после return записали что-то для вывода в консоле, и после 3 ничего не видим, функция прекратилол свою работу
}
test();
