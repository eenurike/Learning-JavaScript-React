...
// Метод массивов который используется больше всех в коде, метод forEach, этот метод позволляет нам гибко перебрать все элементы котрые находятся в массиве, по факту он служит точно так же как и эти два способа выше, но с некотрыми отличиями, мы его можем более подробно настроить
