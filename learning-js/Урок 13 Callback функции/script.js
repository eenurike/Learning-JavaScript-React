...
function learnJS(lang, callback) {
  ...
  callback();
  // Тут выполняем эту callback функцию и ВЫЗЫВАЕМ. Получется так, когда выполнится действие первой функции то есть console.log и только после этого в работу вступит сторая функция
}

// learnJS('JavaScript', function() {
//   console.log('Уже знаю callback функции');
// });
// Но так как мы передали анонимную функцию, она потом исчезнет, то есть мы несможем у ней больше обратится, но вполне можно сюда передавать какую-то осознаную функцию
